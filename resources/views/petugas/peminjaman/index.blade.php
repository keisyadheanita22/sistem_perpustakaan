    ...
    <div class="flex flex-1">
        ...
        <main class="flex-1 p-8">
            ...
            <div class="bg-white rounded-xl shadow p-6">
                <div class="flex justify-between items-center mb-6">
                    <a href="{{ route('peminjaman.create') }}" class="text-white px-4 py-2 rounded text-sm font-medium" style="background-color:#db2777;">+ Tambah Peminjaman</a>
                        ...
                        <tr class="border-b hover:bg-pink-50 transition">
                            ...
                            <td class="px-4 py-4">
                                <span class="px-2 py-1 rounded-full text-xs font-medium text-white"
                                    style="background-color: {{ $item->status == 'dipinjam' ? '#dc2626' : '#16a34a' }}">
                                    {{ ucfirst($item->status) }}
                                </span>
                            </td>
                            <td class="px-4 py-4">
