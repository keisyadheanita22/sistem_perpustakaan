                ...
                <tr class="border-b hover:bg-pink-50 transition">
                    ...
                    <td class="px-4 py-4">
                        <div class="flex gap-2 items-center">
                            ...
                            {{-- Tombol Cetak - pakai data attribute, TANPA window.open agar tidak diblokir browser --}}
                            <button
                                type="button"
                                class="btn-cetak text-white px-3 py-1 rounded text-xs font-medium"
...
{{-- Modal Print (menggantikan window.open agar tidak diblokir popup blocker) --}}
<div id="print-modal" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,0.5); z-index:9999; align-items:center; justify-content:center;">
    <div style="background:white; border-radius:12px; width:480px; max-width:95vw; overflow:hidden; box-shadow:0 20px 60px rgba(0,0,0,0.3);">
...
<script>
    ...
    document.querySelectorAll('.btn-cetak').forEach(function(btn) {
        btn.addEventListener('click', function() {
            ...
            document.getElementById('p-per-hari').textContent = formatRupiah(perHari);
            document.getElementById('p-total').textContent    = formatRupiah(total);
    ...
    function doPrint() {
        // Sembunyikan semua elemen kecuali print-area, lalu print
        ...
        // Re-attach event listeners setelah restore innerHTML
        location.reload();
    }
