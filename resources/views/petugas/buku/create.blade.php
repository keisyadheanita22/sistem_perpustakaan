        ...
        <main class="flex-1 flex items-start justify-center p-8">
            <div class="w-full max-w-md">
                <div class="rounded-xl overflow-hidden shadow-lg">
                    <div class="px-6 py-3 text-white text-sm font-semibold" style="background-color:#db2777;">+ Tambah Buku</div>
                    <div class="bg-white px-8 py-6">
                        <form action="{{ route('buku.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4 text-center">
                                ...
                                <input type="text" name="judul" value="{{ old('judul') }}" class="border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400 w-64">
                                @error('judul') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                            </div>
                            <div class="mb-4 text-center">
                                <label class="block text-sm text-gray-600 mb-1">Pengarang</label>
                                <input type="text" name="pengarang" value="{{ old('pengarang') }}" class="border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400 w-64">
                            ...
                            <div class="mb-4 text-center">
                                ...
                                <input type="text" name="penerbit" value="{{ old('penerbit') }}" class="border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400 w-64">
                            ...
                            <div class="mb-6 text-center">
                                ...
                                <input type="number" name="stok" value="{{ old('stok') }}" min="0" class="border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400 w-64">
